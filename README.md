...
|DELETE | /api/carritos/{correoUsuario}/lineaCarrito/{idLineaCarrito} | No pide un cuerpo | Elimina la linea del carrito indicada, además actualiza el precio final del carrito |
